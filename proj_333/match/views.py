...
class GroupForm(forms.ModelForm):
    ...
    members = forms.ModelMultipleChoiceField(queryset=Profile.objects.all().filter(wants_group=True).order_by('user__first_name'), widget=forms.CheckboxSelectMultiple())
